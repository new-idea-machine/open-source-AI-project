...
export default function Home() {
  ...
  return (
    <div className="flex h-full w-full overflow-clip">
      ...
      <div className="flex flex-col flex-1 w-[38%]">
        <ChatToolBar />
        <div className="flex flex-col flex-1 w-full items-center justify-between">
          <div className="w-full">
            <div className="text-5xl font-extrabold bg-gradient-to-r from-teal-300 via-teal-600 to-teal-300 bg-clip-text text-transparent text-center sm:text-5xl p-2">
            ...
            <div className="w-full">
              ...
              {analyzing ? (
                ...
                <div className="w-[50%]">
                  <div className="w-[600px] drop-shadow-xl">
